    ...
    callbacks: {
        async jwt ({ token, user, account }) {
            if (user && account) {
                ...
                try {
                    const accessToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateAccessToken"])({
                        userId: user.id,
                        email: user.email || '',
                        role: user.role,
                        storeId: user.storeId
...
//# sourceMappingURL=%5Broot-of-the-server%5D__108683e4._.js.map